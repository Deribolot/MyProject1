...
<div class="content">
    ...
    <form method="POST" enctype="multipart/form-data">
        ...
        <h4><input type="hidden" name="login" value="<?= $aData["login"]  ?>">
            ...
            <div ><textarea name="name" rows="1" cols="55" wrap="virtual" placeholder="Введите название новой записи" required maxlength="255"></textarea></div>
            <div >Текст новости:</div>
            <div ><textarea name="new" rows="4" cols="55" wrap="virtual" placeholder="Введите текст новой записи" required maxlength="512"></textarea></div>
